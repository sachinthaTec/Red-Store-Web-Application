...
<head>
    ...
    <title>Selling History | Admins | RED STore</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-danger-emphasis fw-bold fs-1">Selling History</label>
            </div>
            ...
            <div class="col-12 bg-light mt-3 mb-3">
                <div class="row">
                    ...
                    <a href="Purchased Report.php"><button class="btn btn-outline-info fs-5 col-12">Product Purchased Reports</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-1 bg-gradient text-center">
                    ...
                    <div class="col-3 bg-gradient text-center">
